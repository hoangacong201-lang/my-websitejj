# my-websitejj
<!DOCTYPE html>
<!-- saved from url=(0041)file:///D:/code20t10/code20t10/index.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <title>Chúc mừng 20/10</title>
    <link href="./Chúc mừng 20_10 mới_files/css2" rel="stylesheet">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="center-message">
        <strong>Happy Holidays 20-10</strong> <!--Sửa tiêu đề chúc mừng ở đây-->
        <span id="centerText">Chúc cho em những năm tháng sau này có thể cười nhiều hơn, khóc ít đi, hạnh phúc nhân đôi. Chúc cho em những năm tháng sau này đi đúng đường, chọn đúng người, bao nhiêu hạnh phúc đều là của em ❤️</span>
    </div>

    <!-- Ảnh động trang trí -->
    <img src="./Chúc mừng 20_10 mới_files/mewmew.gif" alt="GIF" class="center-gif"> <!-- Thay ảnh động bên dưới -->

    <!-- Hiển thị lời chúc -->
    <div class="popup" id="popup" data-current-message="Chúc bạn luôn vui vẻ, xinh đẹp và ngập tràn yêu thương!" style="display: none;">
        <div class="popup-content">
            <img id="popupImage" src="./Chúc mừng 20_10 mới_files/a1.jpg" alt="Lời chúc">
            <p id="popupMessage">Chúc bạn luôn vui vẻ, xinh đẹp và ngập tràn yêu thương!</p>
        </div>
    </div>
        ...
        const messages = [
            {
                ...
                text: "Chúc em luôn vui vẻ, xinh đẹp và ngập tràn yêu thương!" //Thay lời nhắn
            },
            {
                img: "./assets/a2.jpg",
            ...
            {
                img: "./assets/a3.jpg",
                text: "Cảm ơn em vì đã luôn mạnh mẽ và tuyệt vời như thế!"
            },
            {
                img: "./assets/a4.jpg",
                text: "Chúc em một ngày 20/10 thật hạnh phúc và trọn vẹn! "
            },
            {
                img: "./assets/a5.jpg",
                text: "Em là món quà tuyệt vời nhất mà cuộc sống mang lại! "
            }
        ];
...
<img src="./Chúc mừng 20_10 mới_files/t5.png" class="falling-letter" style="left: 850.76px;"><img src="./Chúc mừng 20_10 mới_files/t5.png" class="falling-letter" style="left: 623.358px;"><img src="./Chúc mừng 20_10 mới_files/h1.png" class="falling-letter" style="left: 157.273px;"><img src="./Chúc mừng 20_10 mới_files/q3.png" class="falling-letter" style="left: 812.07px;"><img src="./Chúc mừng 20_10 mới_files/h3.png" class="falling-letter" style="left: 416.716px;"><img src="./Chúc mừng 20_10 mới_files/letters.png" class="falling-letter" style="left: 654.606px;"><img src="./Chúc mừng 20_10 mới_files/letters.png" class="falling-letter" style="left: 798.872px;"><img src="./Chúc mừng 20_10 mới_files/t5.png" class="falling-letter" style="left: 425.548px;"></body></html>
